...
// 	protoc        v3.21.12
// source: pkg/pb/product.go.proto
...
var file_pkg_pb_product_proto_goTypes = []interface{}{
	(*CreateProductRequest)(nil),  // 0: product.go.CreateProductRequest
	(*CreateProductResponse)(nil), // 1: product.go.CreateProductResponse
	(*FindOneData)(nil),           // 2: product.go.FindOneData
	(*FindOneRequest)(nil),        // 3: product.go.FindOneRequest
	(*FindOneResponse)(nil),       // 4: product.go.FindOneResponse
	(*DecreaseStockRequest)(nil),  // 5: product.go.DecreaseStockRequest
	(*DecreaseStockResponse)(nil), // 6: product.go.DecreaseStockResponse
}
var file_pkg_pb_product_proto_depIdxs = []int32{
	2, // 0: product.go.FindOneResponse.data:type_name -> product.go.FindOneData
	0, // 1: product.go.ProductService.CreateProduct:input_type -> product.go.CreateProductRequest
	3, // 2: product.go.ProductService.FindOne:input_type -> product.go.FindOneRequest
	5, // 3: product.go.ProductService.DecreaseStock:input_type -> product.go.DecreaseStockRequest
	1, // 4: product.go.ProductService.CreateProduct:output_type -> product.go.CreateProductResponse
	4, // 5: product.go.ProductService.FindOne:output_type -> product.go.FindOneResponse
	6, // 6: product.go.ProductService.DecreaseStock:output_type -> product.go.DecreaseStockResponse
